...
public interface IAreaService {
    ...
    Message<City> deleteCity(Long id, User user) throws BadRequestException, EntityNotFoundException, EntityNotSavedException;
    ...
    Message<Locality> deleteLocality(Long id, User user) throws BadRequestException, EntityNotFoundException, EntityNotSavedException;
    ...
    Message<SubLocality> deleteSubLocality(Long id, User user) throws BadRequestException, EntityNotFoundException, EntityNotSavedException;
}
